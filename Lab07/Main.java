...
public class Main {
    ...
    private static Card createCard(String companyName, double balance, String type) {
        // Membuat object card berdasarkan type-nya
    ...
    public static void buyItem() {
        ...
        // Membeli item dengan kartu yang dipilih
    ...
    public static void topup() {
        ...
        // Top up kartu yang dipilih jika merupakan ElectronicCard
        if (card instanceof  ElectronicCard) {
            ElectronicCard electronicCard = (ElectronicCard) card;
            electronicCard.topup(amount);
